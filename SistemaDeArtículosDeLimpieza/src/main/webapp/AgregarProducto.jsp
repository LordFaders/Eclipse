...
<body class="main">
	<nav class="navbar navbar-expand-lg navbar-dark bg-primary"
		style="background-color: rgba(106, 71, 29, 0.817);">
	...
	<div class="container col-4 text-primary fw-bold" style="margin-top:12%">
	...
	<form action="agregarProducto" method="post">
		<h3 class="text text-primary" >Ingrese los datos del nuevo producto</h3>
		<div class="mb-3">
			<label for="nombre_producto" class="form-label">Nombre</label> <input type="text" class="form-control"
				id="nombre_producto" name="nombre_producto" placeholder="Ingrese nombre del producto">
		</div>
		<div class="mb-3">
			<label for="precio_producto" class="form-label">Precio</label> <input type="text" class="form-control"
				id="precio_producto" name="precio_producto" placeholder="Ingrese precio del producto">
		</div>
		<div class="mb-3">
			<label for="descripcion_producto" class="form-label">Descripción</label> <input type="text" class="form-control"
				id="descripcion_producto" name="descripcion_producto" placeholder="Ingrese la descripción del producto">
		</div>
		...
		<button type="submit" class="btn btn-primary mt-3 fw-bold">Agregar Producto</button>
	</form>
	</div>
	<script
